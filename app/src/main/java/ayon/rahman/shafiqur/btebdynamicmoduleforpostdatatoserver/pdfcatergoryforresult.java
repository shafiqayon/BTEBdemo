...
public class pdfcatergoryforresult extends AppCompatActivity {
    public static final String KEY_USERNAME = "name";
    public ArrayList<String> strArrcategory = new ArrayList<String>();
    String SERVERADDRESS = "http://www.inanik.info/project/pdfcategoryviewforresult.php";
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog progressDialog = ProgressDialog.show(pdfcatergoryforresult.this, "Wait", "Syncing Notice", true);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            adapter = new ArrayAdapter<String>(pdfcatergoryforresult.this, R.layout.custom_textview, category);
                            ...
                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    Intent i = new Intent(pdfcatergoryforresult.this, pdftitleforresult.class);
