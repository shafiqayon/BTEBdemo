...
public class pdf extends AppCompatActivity {
    ...
    String category, categoryname, SERVERADDRESS = "http://www.inanik.info/project/pdftitletoitems.php";
    WebView webview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog progressDialog = ProgressDialog.show(pdf.this, "Wait", "Downloading Notice", true);
