...
public class pdfresult extends AppCompatActivity {
    ...
    String category, categoryname, SERVERADDRESS = "http://www.inanik.info/project/pdftitletoitemsresult.php";
    WebView webview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog progressDialog = ProgressDialog.show(pdfresult.this, "Wait", "Downloading Notice", true);
