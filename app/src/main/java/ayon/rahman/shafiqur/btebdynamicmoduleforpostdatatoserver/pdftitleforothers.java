...
public class pdftitleforothers extends AppCompatActivity {
    public static final String KEY_USERNAME = "name";
    public ArrayList<String> strArrcategory = new ArrayList<String>();
    String categoryname, SERVERADDRESS = "http://www.inanik.info/project/pdfcategorytotitleother.php";
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog progressDialog = ProgressDialog.show(pdftitleforothers.this, "Wait", "Syncing Notice", true);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            adapter = new ArrayAdapter<String>(pdftitleforothers.this, R.layout.custom_textview, category);
