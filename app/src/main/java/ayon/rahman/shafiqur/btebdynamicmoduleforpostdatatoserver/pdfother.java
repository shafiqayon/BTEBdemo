...
public class pdfother extends AppCompatActivity {

    public ArrayList<String> strArrcategory = new ArrayList<String>();
    String category, categoryname, SERVERADDRESS = "http://www.inanik.info/project/pdftitletoitemsother.php";
    WebView webview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog progressDialog = ProgressDialog.show(pdfother.this, "Wait", "Downloading Notice", true);
